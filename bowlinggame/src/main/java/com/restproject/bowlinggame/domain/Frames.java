...
import com.restproject.bowlinggame.exception.NoSuchFrameException;
import com.restproject.bowlinggame.helper.PlayedFramePredicate;

/**
 * This is a helper wrapper class that provides abstraction and utility methods
 * for dealing with {@link Frame}.
 *
 * This class also implements {@link Iterable<T>} which means that can be
 * used in loops to iterate its items.
 *
 * @author aishws
 */
public class Frames implements Iterable<Frame> {
    ...
    /**
     * Constructor that initializes all frames and sets the first frame as the
     * current frame.
     */
    public Frames() {
