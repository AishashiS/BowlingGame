...
import com.restproject.bowlinggame.exception.InvalidNumberOfPinsException;
...
public class Frame {
     ...
     *
     * Rules
     * If the two throws don't knock the 10 pins, the score will be the sum
     * of throw 1 + throw 2, i.e. throw 1 = 4, throw = 2, score = 6
     * If the two throws knock down the 10 pins, the score will be 10 (
     * number of pins) + the pins dropped in the next throw (belonging to the
     * next frame), i.e. throw 1 = 5, throw 2 = 5, throw 3 = 4, score = 13.
     * If the 10 pins are knocked down in one throw (strike), and
     ...
     *
     * 
     * frame 1, first throw 10
     * frame 2, first throw 10
     * frame 3, first throw 2
     * 
     *
